...
// == SceneSphere ==============================================
// virtual public
float SceneSphere::IntersectionTest(Ray pRay)
{
    float t_return = -1.0;
...
// virtual public
Vector SceneSphere::GetColor(SceneLight pLight, Ray lookVector, float pDist)
{
...
// virtual public
Vector SceneSphere::GetNormal(Ray pRay, float intersectionTime)
{
...
// virtual public
Vector SceneSphere::GetReflectivity(Ray pRay, float intersectionTime)
{
...
// virtual public
Vector SceneSphere::GetRefractivity(Ray pRay, float intersectionTime)
{
    SceneMaterialMgr &matMgr = SceneMaterialMgr::GetInstance();
...
// == SceneTriangle ==============================================
// private
Vector SceneTriangle::BarycentricCooef(Vector point)
{
...
// virtual private
float SceneTriangle::IntersectionTest(Ray pRay)
{
    float t = -1.0;
...
// virtual private
Vector SceneTriangle::GetColor(SceneLight pLight, Ray lookVector, float pDist)
{
...
// virtual private
Vector SceneTriangle::GetNormal(Ray pRay, float intersectionTime)
{
...
// virtual private
Vector SceneTriangle::GetReflectivity(Ray pRay, float intersectionTime)
...
// virtual private
Vector SceneTriangle::GetRefractivity(Ray pRay, float intersectionTime)
{
    SceneMaterialMgr &matMgr = SceneMaterialMgr::GetInstance();
    Vector out(0.0, 0.0, 0.0);
    Vector surfPt = pRay.GetPoint(intersectionTime);
...
// == SceneModel ===================================================
float SceneModel::IntersectionTest(Ray pRay)
{
    float t = FLT_MAX;
...
int SceneModel::intersectingTriangleIdx(Ray pRay)
{
    float t = FLT_MAX;
...
Vector SceneModel::GetColor(SceneLight pLight, Ray lookVector, float pDist)
{
...
Vector SceneModel::GetNormal(Ray pRay, float intersectionTime)
{
...
Vector SceneModel::GetReflectivity(Ray pRay, float intersectionTime)
{
...
Vector SceneModel::GetRefractivity(Ray pRay, float intersectionTime)
{
    Vector refOut(0.0, 0.0, 0.0);
    int triangleIntersectionIdx =  intersectingTriangleIdx(pRay);
    if(triangleIntersectionIdx >= 0.0 && triangleIntersectionIdx < triangleList.size())
...
Vector Scene::ParseXYZ(XMLNode node)
{
    if (node.isEmpty ())
...
// public
unsigned int Scene::GetNumMaterials(void)
{
