...
void NormalRenderer::RenderScene()
{
    if(m_pScene)
    {
        UnsetRenderStates();
        ...
        gluPerspective(
           ...
           (GLdouble)WINDOW_WIDTH/WINDOW_HEIGHT, 
            sceneCam.GetNearClip(), 
            sceneCam.GetFarClip());
        glMatrixMode( GL_MODELVIEW);
        glLoadIdentity();

        gluLookAt(
            sceneCam.position.x, sceneCam.position.y, sceneCam.position.z,
        ...
        for( unsigned int n = 0; n < numObjs; n++)
        {
            ...
            if(sceneObj->IsSphere())
            {
                ...
                glScalef( ((SceneSphere *)sceneObj)->scale.x, 
                    ((SceneSphere *)sceneObj)->scale.y, 
                    ((SceneSphere *)sceneObj)->scale.z);
            ...
            else if(sceneObj->IsTriangle())
            {
                ...
                glScalef(
                   ((SceneTriangle *)sceneObj)->scale.x, 
                   ((SceneTriangle *)sceneObj)->scale.y, 
                   ((SceneTriangle *)sceneObj)->scale.z);
                ...
                glColor3fv( (GLfloat *)&sceneMat.diffuse);
                glTexCoord2f(
                   ((SceneTriangle *)sceneObj)->u[0], 
                   ((SceneTriangle *)sceneObj)->v[0]);
                glNormal3f(
                   ((SceneTriangle *)sceneObj)->normal[0].x, 
                   ((SceneTriangle *)sceneObj)->normal[0].y, 
                   ((SceneTriangle *)sceneObj)->normal[0].z);
                glVertex3f(
                   ((SceneTriangle *)sceneObj)->vertex[0].x, 
                   ((SceneTriangle *)sceneObj)->vertex[0].y, 
                   ((SceneTriangle *)sceneObj)->vertex[0].z);
                ...
                glNormal3f( ((SceneTriangl e *)sceneObj)->normal[1].x,
                    ((SceneTriangle *)sceneObj)->normal[1].y,
                    ((SceneTriangle *)sceneObj)->normal[1].z);
                glVertex3f( ((SceneTriangle *)sceneObj)->vertex[1].x,
                ((SceneTriangle *)sceneObj)->vertex[1].y,
                ((SceneTriangle *)sceneObj)->vertex[1].z);

                sceneMat = materialMgr.GetMaterial( ((SceneTriangle *)sceneObj)->material[2]);
                glColor3fv( (GLfloat *)&sceneMat.diffuse);
                glTexCoord2f( ((SceneTriangle *)sceneObj)->u[2],
                ((SceneTriangle *)sceneObj)->v[2]);
                glNormal3f( ((SceneTriangle *)sceneObj)->normal[2].x,
                ((SceneTriangle *)sceneObj)->normal[2].y,
                ((SceneTriangle *)sceneObj)->normal[2].z);
                glVertex3f( ((SceneTriangle *)sceneObj)->vertex[2].x,
                ((SceneTriangle *)sceneObj)->vertex[2].y,
                ((SceneTriangle *)sceneObj)->vertex[2].z);
            ...
            else if(sceneObj->IsModel())
            {
                ...
                glTranslatef( translate.x, translate.y, translate.z);
                glRotatef(((SceneModel *)sceneObj)->rotation.x,
                1.0f, 0.0f, 0.0f);
                glRotatef( ((SceneModel *)sceneObj)->rotation.y, 0.0f,
                .0f, 0.0f);
                glRotatef( ((SceneModel *)sceneObj)->rotation.z,
                0.0f, 0.0f, 1.0f);
                glScalef( ((SceneModel *)sceneObj)->scale.x,
                ((SceneModel *)sceneObj)->scale.y,
                ((SceneModel *)sceneObj)->scale.z);
                ...
                for( unsigned int n = 0; n < numTris; n++)
                {
                    ...
                    glNormal3f( sceneTri->normal[0].x,
                    sceneTri->normal[0].y,
                    sceneTri->normal[0].z);
                    glVertex3f( sceneTri->vertex[0].x,
                    sceneTri->vertex[0].y,
                    sceneTri->vertex[0].z);

                    glTexCoord2f( sceneTri->u[1],
                    sceneTri->v[1]);
                    glNormal3f( sceneTri->normal[1].x,
                    sceneTri->normal[1].y,
                    sceneTri->normal[1].z);
                    glVertex3f( sceneTri->vertex[1].x,
                    sceneTri->vertex[1].y,
                    sceneTri->vertex[1].z);

                    glTexCoord2f( sceneTri->u[2],
                    sceneTri->v[2]);
                    glNormal3f( sceneTri->normal[2].x,
                    sceneTri->normal[2].y,
                    sceneTri->normal[2].z);
                    glVertex3f( sceneTri->vertex[2].x,
                    sceneTri->vertex[2].y,
                    sceneTri->vertex[2].z);
                }
...
//private
void NormalRenderer::SetRenderStates()
{
...
//private
void NormalRenderer::UnsetRenderStates()
{
